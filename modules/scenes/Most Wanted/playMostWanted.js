import { brickTexture, c, centerX, centerY, height, resScale, width } from "../../../Main.js";
...
function leaderboard () {
    c.font = `${25*resScale()}px oswald`;
    c.textAlign = 'left';
    c.fillStyle = 'rgb(255, 255, 255)';
    for (let i = 0; i < points.length; i++) {
        c.fillText(`${player[i].name}: ${points[i].toFixed(2)} seconds`, width*0.025, height*0.05 + 60*resScale(true)*i)
    }
}
...
export function resetGameMostWanted () {
    bgm = new Audio('./modules/scenes/Most Wanted/sounds/Le Grand Chase.mp3')
    gameStarted = false;
    endGame = false;

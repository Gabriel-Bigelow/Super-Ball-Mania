import { c, centerX, centerY, height, resScale } from "../../../Main.js";
...
export function resetGameLightOnYourFeet () {
    bgm = new Audio('./modules/scenes/Light On Your Feet/sounds/bgm.mp3')
    gameStarted = false;
    endGame = false;
    ...
    tileRows = [];
    tileColumns = [];
    tileInactiveColor = 'rgb(150, 150, 150)';
    playerWalked = [];

import { c, width, height, centerX, centerY, canvas } from '../Main.js';
...
export let buttonKeyboardOnly, buttonControls, buttonPlayNow, buttonPlayerCustomization, buttonPreviousScreen, buttonNewGame;
export function initializeTitleScreenButtons () {
    buttonKeyboardOnly = new Button(centerX, height*0.75, 200, 80, 'Keyboard Only');
    buttonControls = new Button(centerX+width*5/24, height*0.75 - 150, 300, 100, 'Controls');
...
export function initializeGameSelectButtons () {
    ...
    spaceEvenly(gameButtons, true, 50, 200);
...
export function initializePlaySceneButtons () {
    buttonMainMenu = new Button(width-100, 270, 100, 75, 'Main Menu');
    buttonCloseGame = new Button(width-100, 70, 100, 75, 'Close Game');
    buttonFullscreen = new Button(width-220, 70, 100, 75, 'Fullscreen');
}

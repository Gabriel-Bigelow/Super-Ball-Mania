import { c, centerX, centerY, changeScene, confetti, height, width } from "../Main.js";
...
import { restartFlappyBalls } from "./scenes/Flappy Balls/playFlappyBalls.js";
import { games, removeFirstGame, removeRandomGame } from "./scenes/gameSelect.js";
import { sceneTitle, themeMusic } from "./scenes/titleScreen.js";
...
function sceneEndGame () {
    ...
    image(confetti[Math.floor(confettiFrame)], player[winner].x, player[winner].y);
    confettiFrame ++

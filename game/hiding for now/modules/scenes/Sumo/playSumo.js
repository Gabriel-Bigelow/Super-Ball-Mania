import { c, centerX, centerY, glassTexture, height, lavaTexture, width } from "../../../Main.js";
...
import { keyCode, keyInputArray, keys } from "../../listeners/keyListener.js";
...
function assignPlayer5Controls () {
    player[4].controllerType = 'gamepad';
    player[4].boundUp = 3;
    player[4].boundRight = 2;
    player[4].boundA = 3;
    player[4].boundB = 4;
    player[4].boundX = 2;
    player[4].boundY = 3;
    ...
    player[4].boundLT = 6;
    player[4].boundRT = 7;
    player[4].boundSelect = 8;
    player[4].boundPause = 9;
    player[4].boundLSClicked = 10;
    player[4].boundRSClicked = 11;
    player[4].boundDPadUp = 12;
    player[4].boundDPadDown = 13;
    player[4].boundDPadLeft = 14;
    player[4].boundDPadRight = 15;
    player[4].cNum = 2;
}
...
function leaderboard () {
    ...
    c.font = '30px oswald';
    c.textAlign = 'left';
    c.fillText('Still Alive', 50, 50);
    c.fillRect(50, 55, 105, 5)
    for (let i = 0; i < playersLeft.length; i++){
        c.fillText(`${playersLeft[i].name}`, 50, 100 + 50*i);
    }
}
